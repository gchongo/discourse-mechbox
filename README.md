...
**Phase 1.3（待生产验证）**：首个单工具 `gear_ratio` 端到端；`POST /mechbox/api/calculate` 可用；工具页路由 `/mechbox/tools/gear_ratio`。
...
| `phase1_3` | 2026-07-12 | 扁平路由 `mechbox-tool`；首页仅 `gear_ratio` 可点击；工具页表单 + 计算结果 | 待验证：齿轮比可算；首页不 502 |
