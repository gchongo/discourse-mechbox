...
**Phase 0.5.7（待生产验证）**：`/mechbox` 已从 metadata API 渲染内置工具和延期设计链目录；目前仅展示，不提供计算入口。
...
| `phase0_5_7` | 2026-07-11 | `/mechbox` 路由加载 metadata；页面展示 5 个内置工具及延期设计链；保持单路由且无动态 helper | 待验证：页面不再显示骨架占位内容 |
| `phase0_5_8` | — | 计划：恢复用户偏好数据 | 待做 |
